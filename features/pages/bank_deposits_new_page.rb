class BankDepositsNewPage < SitePrism::Page
    include GeneratorFaker
    include BaseHelper
    include RSpec::Matchers
    set_url "/bank_deposits/new"
    set_url_matcher %r{.*/bank_deposits/new}
  
    element :payer_dropdown, "#select2-chosen-8"
    ...
    element :payer_type_dropdown, "#select2-chosen-4"
    element :add_new_payer_btn, "#add-new-person"
    element :deposit_to_dropdown, "#select2-chosen-14"
    element :deposit_account_name, :xpath, "(//input[@id='account_name'])[3]"
    element :deposit_account_tax, "#select2-chosen-13"
    element :deposit_account_category_dropdown, "#select2-chosen-3"
    ...
    def fill_receiving_details(transaction_details, data_number = 1, type = "vendor", payer, amount, date)
    ...
    def select_deposit_to(value)
      ...
      wait_until_deposit_to_dropdown_visible
